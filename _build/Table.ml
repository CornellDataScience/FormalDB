...
module Table =
 struct
  ...
  (** val add_row : row -> table -> (row list, header) prod **)

  let add_row r = function
  | Pair (t, ident) ->
  ...
  (** val test_tbl : (row list, header) prod **)

  let test_tbl =
    add_header (Cons ((String ((Ascii (False, True, True, True, False, False, True,
      False)), (String ((Ascii (True, False, False, False, False, True, True, False)),
      (String ((Ascii (True, False, True, True, False, True, True, False)), (String
      ((Ascii (True, False, True, False, False, True, True, False)), EmptyString)))))))),
      (Cons ((String ((Ascii (True, False, False, True, True, False, True, False)),
      ...
      (False, True, False, False, True, True, True, False)), EmptyString)))))))), (Cons
      ((String ((Ascii (True, False, False, False, False, False, True, False)), (String
      ((Ascii (False, False, True, False, False, True, True, False)), (String ((Ascii
      (False, False, True, False, False, True, True, False)), (String ((Ascii (False,
      True, False, False, True, True, True, False)), (String ((Ascii (True, False, True,
      False, False, True, True, False)), (String ((Ascii (True, True, False, False, True,
      True, True, False)), (String ((Ascii (True, True, False, False, True, True, True,
      False)), EmptyString)))))))))))))), (Cons ((String ((Ascii (True, False, True, True,
      False, False, True, False)), (String ((Ascii (True, False, False, False, False,
      True, True, False)), (String ((Ascii (False, True, False, True, False, True, True,
      False)), (String ((Ascii (True, True, True, True, False, True, True, False)),
      (String ((Ascii (False, True, False, False, True, True, True, False)),
      EmptyString)))))))))), Nil)))))))) empty_table

  (** val test_tbl_1 : (row list, header) prod **)

  let test_tbl_1 =
    add_row (Cons ((Coq_string_entry (String ((Ascii (True, False, False, False, False,
      False, True, False)), (String ((Ascii (False, False, False, True, False, True, True,
      False)), (String ((Ascii (True, False, False, False, False, True, True, False)),
      (String ((Ascii (False, False, True, False, False, True, True, False)),
      EmptyString))))))))), (Cons ((Coq_nat_entry (S (S (S (S (S (S (S (S (S (S (S (S (S
      ...
      O)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))),
      (Cons ((Coq_string_entry (String ((Ascii (True, False, False, False, False, False,
      True, False)), (String ((Ascii (False, False, True, False, False, True, True,
      ...
      (True, True, False, False, True, True, True, False)), (String ((Ascii (True, True,
      False, False, True, True, True, False)), EmptyString))))))))))))))), (Cons
      ((Coq_string_entry (String ((Ascii (True, True, False, False, False, False, True,
      False)), (String ((Ascii (True, True, True, True, False, True, True, False)),
      (String ((Ascii (True, False, True, True, False, True, True, False)), (String
      ((Ascii (False, False, False, False, True, True, True, False)), (String ((Ascii
      (True, False, True, False, True, True, True, False)), (String ((Ascii (False, False,
      True, False, True, True, True, False)), (String ((Ascii (True, False, True, False,
      False, True, True, False)), (String ((Ascii (False, True, False, False, True, True,
      ...
      (True, False, True, False, False, True, True, False)), (String ((Ascii (False, True,
      True, True, False, True, True, False)), (String ((Ascii (True, True, False, False,
      False, True, True, False)), (String ((Ascii (True, False, True, False, False, True,
      True, False)), EmptyString))))))))))))))))))))))))))))))))), Nil)))))))) test_tbl

  (** val entry_is_haram : entry -> bool **)

  let entry_is_haram = function
  | Coq_string_entry s ->
    (match string_dec s (String ((Ascii (False, False, False, True, False, False, True,
